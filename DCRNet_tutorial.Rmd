...
The utility functions for delineating dynamic lncRNA causal regulation are collected in the source file: **DCRNet.R**. In this tutorial, we select three sequential causality methods (DCRNet, Granger, seqICP) to infer dynamic lncRNA causal regulation from ASD single-nucleus RNA sequencing data. The priori information of lncRNA targets has two cases: None (no priori information), LncTar (priori information of LncTar).
...
```
## Step 3: Causal inference using DCRNet, Granger, seqICP
```{r, eval=TRUE, include=TRUE}
################################################################################  DCRNet application ############################################################################
# ASD and Normal
